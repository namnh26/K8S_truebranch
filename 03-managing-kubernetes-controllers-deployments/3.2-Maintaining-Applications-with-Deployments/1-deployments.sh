ssh aen@c1-cp1
cd ~/k8s-advance-course/03-managing-kubernetes-controllers-deployments/3.2-Maintaining-Applications-with-Deployments
...
kubectl describe replicaset hello-world-54575d5b77

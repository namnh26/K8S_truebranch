ssh aen@c1-cp1
cd ~/k8s-advance-course/06-maintaining-monitoring-troubleshooting-kubernetes/6.1-Maintaining-Kubernetes-Clusters
...
sudo apt-get update
sudo apt-get install -y kubeadm=1.21.7-00
...
sudo apt-get update
sudo apt-get install -y kubelet=1.21.7-00 kubectl=1.21.7-00
